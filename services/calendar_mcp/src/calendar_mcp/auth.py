...
own `CALENDAR_MCP_STDIO_ROLE` env var and `CalendarMCPSettings`.
"""
...
resolve_actor: ActorResolver = build_actor_resolver(
    stdio_role_env_var="CALENDAR_MCP_STDIO_ROLE",
    stdio_role_default=lambda: get_calendar_mcp_settings().calendar_mcp_stdio_role,
)
