...
own `PROJECT_MCP_STDIO_ROLE` env var and `ProjectMCPSettings`.
"""
...
resolve_actor: ActorResolver = build_actor_resolver(
    stdio_role_env_var="PROJECT_MCP_STDIO_ROLE",
    stdio_role_default=lambda: get_project_mcp_settings().project_mcp_stdio_role,
)
