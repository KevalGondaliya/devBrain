...
own `GITHUB_MCP_STDIO_ROLE` env var and `GithubMCPSettings`.
"""
...
resolve_actor: ActorResolver = build_actor_resolver(
    stdio_role_env_var="GITHUB_MCP_STDIO_ROLE",
    stdio_role_default=lambda: get_github_mcp_settings().github_mcp_stdio_role,
)
